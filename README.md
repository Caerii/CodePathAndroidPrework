# Android Prework - *Sus Generator*

Submitted by: **Alif Jakir**

**Sus Generator** is an android app that shows an image and introductory message, and allows pressing a button to display a Toast. 
